    ...
    <>
      <div className="flex gap-6">
          ...
          {referralLevel.map((level) => (
            <>
              <div className="flex items-center">
                <div className="rounded-full bg-shadow w-[34px] h-[34px]"></div>
                <div className="bg-low-contrast h-[1px] w-[61px]"></div>
                <div className="rounded-[48px] bg-shadow py-2 px-6 flex items-center w-[300px] gap-3">
                  <p className={`${Fonts.Text.Medium} text-high-contrast`}>
                    Level {level}
                  </p>
                  <p className={`${Fonts.Text.Book} text-low-contrast`}>
                    Refer 1 friend
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col w-1/2">
          <h1 className={Fonts.Headings.Subtitle.Bold}>Refer a friend</h1>
